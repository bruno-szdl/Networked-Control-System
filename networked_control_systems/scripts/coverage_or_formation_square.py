...
class SubAndPub:
    def __init__(self):
        ...
        edge = 2.5
        self.distance_between_robots = {"tb3_0" : np.array([[edge, edge, 0], [0, edge, edge]]),
                                        "tb3_1" : np.array([[edge, 0, edge], [0, edge, edge]]),
                                        "tb3_2" : np.array([[edge, 0, edge], [edge, edge, 0]]),
                                        "tb3_3" : np.array([[0, edge, edge], [edge, edge, 0]])}
    ...
    def Callback(self, odom_sub_1_info, odom_sub_2_info, odom_sub_3_info, odom_sub_4_info):
